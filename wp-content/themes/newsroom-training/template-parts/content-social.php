...
<article class="content-card social-card <?php echo esc_attr($platform); ?>-card mb-4 <?php echo $pinned ? 'pinned' : ''; ?>" data-post-id="<?php echo get_the_ID(); ?>">
        ...
        <div class="comments-container">
            ...
            ?>
                <div class="add-comment-form bg-white p-3 rounded">
                    ...
                    <div class="realtime-comment-form" data-post-id="<?php echo get_the_ID(); ?>">
                        <div class="mb-3">
