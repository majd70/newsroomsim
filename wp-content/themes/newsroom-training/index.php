          ...
          <form method="post" action="<?php echo esc_url($_SERVER['REQUEST_URI']); ?>" enctype="multipart/form-data" id="insertForm" novalidate>
            ...
            <div class="modal-body">
              ...
              <ul class="nav nav-tabs mb-3" id="contentTypeTabs" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                  <button class="nav-link" id="twitter-tab" data-bs-toggle="tab" data-bs-target="#twitter-content" type="button" role="tab" aria-controls="twitter-content" aria-selected="false">Twitter</button>
                </li>
                <li class="nav-item" role="presentation">
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <form id="editTwitterForm" method="post" enctype="multipart/form-data">
            ...
            <div class="modal-header">
              <h5 class="modal-title" id="editTwitterModalLabel">Edit Twitter Post</h5>
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
              ...
              <form method="post" enctype="multipart/form-data" id="insertFormStandalone">
                ...
                <div class="modal-body">
                  ...
                  <ul class="nav nav-tabs mb-3" id="contentTypeTabsStandalone" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="twitter-tab-sa" data-bs-toggle="tab" data-bs-target="#twitter-content-sa" type="button" role="tab" aria-controls="twitter-content-sa" aria-selected="false">Twitter</button>
                    </li>
                    <li class="nav-item" role="presentation">
